...
function getCountryCode(cname) {
    var ccodes = Object.keys(isoCountries).keys();
    ...
    console.log('country ' + cname + ' not found');
    return null;
}

function getContinent(cname) {
    var ccode = getCountryCode(cname);
    if (ccode) {
        if (continents.hasOwnProperty(ccode)) {
            return continents[ccode];
        } 
    }
    return null;
}
